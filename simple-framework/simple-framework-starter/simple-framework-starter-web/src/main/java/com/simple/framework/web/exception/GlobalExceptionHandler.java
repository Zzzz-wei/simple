...
import com.simple.framework.common.exception.BaseResultCodeEnum;
import com.simple.framework.common.exception.BizException;
import com.simple.framework.common.result.ResultWrapper;
import com.simple.framework.common.utils.SpringContextUtil;
import com.simple.framework.web.util.RequestUtil;
...
public class GlobalExceptionHandler {
    ...
    private String getExceptionMsgWithStack(Exception exception) {
        ...
        for (StackTraceElement stackTraceElement : exception.getStackTrace()) {
            ...
            if (stackTraceElement.toString().contains("com.simple")) {
